...
class CapacitorGoogleMapsWeb extends _capacitor_core__WEBPACK_IMPORTED_MODULE_1__.WebPlugin {
  ...
  importGoogleLib(apiKey, region, language) {
    ...
    return (0,C_Users_user_Pegasus_1_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      if (_this.gMapsRef === undefined) {
        const lib = yield __webpack_require__.e(/*! import() */ "node_modules_googlemaps_js-api-loader_dist_index_mjs").then(__webpack_require__.bind(__webpack_require__, /*! @googlemaps/js-api-loader */ 9921));
  ...
  addTileOverlay(_args) {
    ...
    return (0,C_Users_user_Pegasus_1_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      const map = _this12.maps[_args.id].map;
      const id = '' + _this12.currTileOverlayId;
      ...
      _this12.maps[_args.id].tileOverlays[id] = customMapOverlay;
      map.overlayMapTypes.push(customMapOverlay);
      _this12.currTileOverlayId++;
      return {
        id: id
      };
    })();
  ...
  removeTileOverlay(_args) {
    ...
    return (0,C_Users_user_Pegasus_1_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const map = _this13.maps[_args.id].map;
      ...
      for (let i = 0; i < map.overlayMapTypes.getLength(); i++) {
        if (map.overlayMapTypes.getAt(i) === _this13.maps[_args.id].tileOverlays[_args.tileOverlayId]) {
          map.overlayMapTypes.removeAt(i);
          delete _this13.maps[_args.id].tileOverlays[_args.tileOverlayId];
          break;
        }
      }
    })();
  ...
  addMarkers(_args) {
    ...
    return (0,C_Users_user_Pegasus_1_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      for (const markerArgs of _args.markers) {
        const advancedMarker = _this14.buildMarkerOpts(markerArgs, map.map);

        const id = '' + _this14.currMarkerId;
        map.markers[id] = advancedMarker;
        yield _this14.setMarkerListeners(_args.id, id, advancedMarker);
        markerIds.push(id);
        _this14.currMarkerId++;
      }
  ...
  addMarker(_args) {
    ...
    return (0,C_Users_user_Pegasus_1_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const advancedMarker = _this15.buildMarkerOpts(_args.marker, _this15.maps[_args.id].map);

      const id = '' + _this15.currMarkerId;
      _this15.maps[_args.id].markers[id] = advancedMarker;
      yield _this15.setMarkerListeners(_args.id, id, advancedMarker);
      _this15.currMarkerId++;
      return {
        id: id
      };
    })();
  ...
  removeMarkers(_args) {
    ...
    return (0,C_Users_user_Pegasus_1_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const map = _this16.maps[_args.id];
  ...
  removeMarker(_args) {
    ...
    return (0,C_Users_user_Pegasus_1_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      if (_this17.maps[_args.id].markers[_args.markerId]) {
        _this17.maps[_args.id].markers[_args.markerId].map = null;
        delete _this17.maps[_args.id].markers[_args.markerId];
      }
    })();
  }
  ...
  addPolygons(args) {
    ...
    return (0,C_Users_user_Pegasus_1_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      for (const polygonArgs of args.polygons) {
        ...
        const id = '' + _this18.currPolygonId;
        _this18.maps[args.id].polygons[id] = polygon;

        _this18.setPolygonListeners(args.id, id, polygon);

        polygonIds.push(id);
        _this18.currPolygonId++;
      }
  ...
  addCircles(args) {
    ...
    return (0,C_Users_user_Pegasus_1_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      for (const circleArgs of args.circles) {
        ...
        const id = '' + _this20.currCircleId;
        _this20.maps[args.id].circles[id] = circle;

        _this20.setCircleListeners(args.id, id, circle);

        circleIds.push(id);
        _this20.currCircleId++;
      }
  ...
  addPolylines(args) {
    ...
    return (0,C_Users_user_Pegasus_1_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const lineIds = [];
      const map = _this22.maps[args.id];
      ...
      for (const polylineArgs of args.polylines) {
        ...
        const id = '' + _this22.currPolylineId;
        _this22.maps[args.id].polylines[id] = polyline;

        _this22.setPolylineListeners(args.id, id, polyline);

        lineIds.push(id);
        _this22.currPolylineId++;
      }
  ...
  removePolylines(args) {
    ...
    return (0,C_Users_user_Pegasus_1_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const map = _this23.maps[args.id];
  ...
  enableClustering(_args) {
    ...
    return (0,C_Users_user_Pegasus_1_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      for (const id in _this24.maps[_args.id].markers) {
        markers.push(_this24.maps[_args.id].markers[id]);
      }

      _this24.maps[_args.id].markerClusterer = new _googlemaps_markerclusterer__WEBPACK_IMPORTED_MODULE_2__.MarkerClusterer({
        map: _this24.maps[_args.id].map,
        markers: markers,
        ...
        onClusterClick: _this24.onClusterClickHandler
      });
    })();
  }
  ...
  disableClustering(_args) {
    ...
    return (0,C_Users_user_Pegasus_1_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const mapInstance = _this25.maps[_args.id];
  ...
  create(_args) {
    ...
    return (0,C_Users_user_Pegasus_1_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      yield _this26.importGoogleLib(_args.apiKey, _args.region, _args.language); // Ensure we have a Map ID for Advanced Markers

      const config = Object.assign({}, _args.config);

      if (!config.mapId) {
        config.mapId = `capacitor_map_${_this26.currMapId++}`;
      }

      _this26.maps[_args.id] = {
      ...
      _this26.setMapListeners(_args.id);
    })();
  }
  ...
  destroy(_args) {
    ...
    return (0,C_Users_user_Pegasus_1_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      const mapItem = _this27.maps[_args.id];
      mapItem.element.innerHTML = '';
      mapItem.map.unbindAll();
      delete _this27.maps[_args.id];
    })();
  }
  ...
  mapBoundsContains(_args) {
    ...
    return (0,C_Users_user_Pegasus_1_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const bounds = _this28.getLatLngBounds(_args.bounds);
  ...
  mapBoundsExtend(_args) {
    ...
    return (0,C_Users_user_Pegasus_1_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const bounds = _this29.getLatLngBounds(_args.bounds);
  ...
  setCircleListeners(mapId, circleId, circle) {
    ...
    return (0,C_Users_user_Pegasus_1_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      circle.addListener('click', () => {
        _this30.notifyListeners('onCircleClick', {
          mapId: mapId,
          circleId: circleId,
          tag: circle.get('tag')
        });
  ...
  setPolygonListeners(mapId, polygonId, polygon) {
    ...
    return (0,C_Users_user_Pegasus_1_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      polygon.addListener('click', () => {
        _this31.notifyListeners('onPolygonClick', {
          mapId: mapId,
          polygonId: polygonId,
          tag: polygon.get('tag')
        });
  ...
  setPolylineListeners(mapId, polylineId, polyline) {
    ...
    return (0,C_Users_user_Pegasus_1_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      polyline.addListener('click', () => {
        _this32.notifyListeners('onPolylineClick', {
          mapId: mapId,
  ...
  setMarkerListeners(mapId, markerId, marker) {
    ...
    return (0,C_Users_user_Pegasus_1_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      marker.addListener('click', () => {
        ...
        _this33.notifyListeners('onMarkerClick', {
          mapId: mapId,
          markerId: markerId,
          latitude: position.lat,
          longitude: position.lng,
      ...
      if (marker.gmpDraggable) {
        marker.addListener('dragstart', () => {
          ...
          _this33.notifyListeners('onMarkerDragStart', {
            mapId: mapId,
            markerId: markerId,
            latitude: position.lat,
            longitude: position.lng,
        ...
        marker.addListener('drag', () => {
          ...
          _this33.notifyListeners('onMarkerDrag', {
            mapId: mapId,
            markerId: markerId,
            latitude: position.lat,
            longitude: position.lng,
        ...
        marker.addListener('dragend', () => {
          ...
          _this33.notifyListeners('onMarkerDragEnd', {
            mapId: mapId,
            markerId: markerId,
            latitude: position.lat,
            longitude: position.lng,
  ...
  setMapListeners(mapId) {
    ...
    return (0,C_Users_user_Pegasus_1_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const map = _this34.maps[mapId].map;
      map.addListener('idle', /*#__PURE__*/(0,C_Users_user_Pegasus_1_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
        var _a, _b;

        const bounds = yield _this34.getMapBounds({
          id: mapId
        });

        _this34.notifyListeners('onCameraIdle', {
          mapId: mapId,
      ...
      map.addListener('center_changed', () => {
        _this34.notifyListeners('onCameraMoveStarted', {
          mapId: mapId,
          isGesture: true
        });
      });
      map.addListener('bounds_changed', /*#__PURE__*/(0,C_Users_user_Pegasus_1_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
        var _a, _b;
        ...
        _this34.notifyListeners('onBoundsChanged', {
          mapId: mapId,
          bearing: map.getHeading(),
          bounds: bounds,
          latitude: (_a = map.getCenter()) === null || _a === void 0 ? void 0 : _a.lat(),
      ...
      map.addListener('click', e => {
        ...
        _this34.notifyListeners('onMapClick', {
          mapId: mapId,
      ...
      _this34.notifyListeners('onMapReady', {
        mapId: mapId
      });
    })();
  }
...
/* harmony import */ var supercluster__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! supercluster */ 8342);
...
/* harmony export */ });
/* harmony import */ var kdbush__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! kdbush */ 9401);
