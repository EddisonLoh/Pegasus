...
AboutPage.ɵcmp = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AboutPage, selectors: [["app-about"]], decls: 26, vars: 9, consts: [[1, "ion-no-border"], ["slot", "start"], ["color", "primary"], ["src", "../assets/imgs/about.svg"], [2, "margin-top", "10%"], ["color", "primary", 1, "ion-text-center"], ["vertical", "bottom", "horizontal", "end", "slot", "fixed"], ["name", "globe"], ["side", "top"], [3, "click"], ["src", "https://cdn.kcak11.com/CountryFlags/countries/us.svg", 2, "width", "24px", "height", "24px"], ["src", "https://cdn.kcak11.com/CountryFlags/countries/sa.svg", 2, "width", "24px", "height", "24px"]], template: function AboutPage_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function AboutPage_Template_ion_fab_button_click_24_listener() { return ctx.changeLanguage("ar"); });
